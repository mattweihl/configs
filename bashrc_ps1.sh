...
function parse_git_branch() {
        ...
        then
                ...
                # echo "${BRANCH}${STAT}"
                echo -e "\e[30;48;5;190m ${BRANCH} \e[0m"
...
export PS1="`prompt_return_code``prompt_time``prompt_user_and_hostname``prompt_current_directory`\`parse_git_branch\``prompt_new_line` "
